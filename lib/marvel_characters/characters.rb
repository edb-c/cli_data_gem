...
def self.get_character_info(input)
   ...
   self.super_name = character_page.css('div.wiki-details').css('table').css('tr')[0].css('td').css('div').css('span').text
   ...
   character_array << super_name << real_name << character_type << number_of_powers << list_of_powers
...
#    self.get_character_info(input)[0].to_s
